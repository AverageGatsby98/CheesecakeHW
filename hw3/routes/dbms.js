...
var host = "35.233.144.220";    //from GCloud instance (change to match your db)
var database = "CHEESECAKE";  //database name
var user = "root";         //username (change to match your db)
var password = "Nbv12345";  //password (change to match your db, yes this is very poor practice)
